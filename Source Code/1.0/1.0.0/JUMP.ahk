...
class MinesweeperApp {
    __New() {
        ...
        this.Gui := Gui("+Resize +MinSize420x300", "JUMP - Minesweeper")
        ...
        this.TxtMines := this.Gui.AddText("x300 y13 w140", "Mines: 0")
        this.TxtTime  := this.Gui.AddText("x+m y13 w140", "Time: 0")
    ...
    ModeToConfig(modeText) {
        if InStr(modeText, "Intermediate")
            return { W: 16, H: 16, Mines: 40 }
        if InStr(modeText, "Expert")
