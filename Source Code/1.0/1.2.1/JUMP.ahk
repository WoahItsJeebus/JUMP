...
class MinesweeperApp {
    __New() {
		...
		this.Gui.Show("AutoSize Center Hide")

		this.Gui.GetPos(&x, &y, &w, &h)
		this.TxtMines.Move(,,(w/2) - this.Padding,)
		this.TxtTime.Move(,,(w/2) - this.Padding,)
    ...
    NewGame(modeText) {
        ...
        this.Gui.Show("AutoSize Center")
		this.Gui.GetPos(&x, &y, &w, &h)
		this.TxtTime.GetPos(&tx, &ty, &tw, &th)
		this.TxtMines.Move(this.Padding*1.25,,(w/2) - this.Padding,)
		this.TxtTime.Move(w/2 - this.Padding*2,,(w/2) - this.Padding,)
		this.TxtMode.Move(,,w - this.Padding*2,)
