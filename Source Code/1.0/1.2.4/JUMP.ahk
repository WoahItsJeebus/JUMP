...
class MinesweeperApp {
    __New() {
		...
		; Game menu
		this.GameMenu := Menu()
		this.GameMenu.Add("New Game", (*) => this.SwitchMode(this.Mode))
		...
		this.DifficultyMenu.Add("Beginner (9x9, 10 Mines)", (*) => this.SwitchMode("Beginner (9x9, 10 Mines)"))
		this.DifficultyMenu.Add("Intermediate (16x16, 40 Mines)", (*) => this.SwitchMode("Intermediate (16x16, 40 Mines)"))
		this.DifficultyMenu.Add("Expert (30x16, 99 Mines)", (*) => this.SwitchMode("Expert (30x16, 99 Mines)"))
        ...
        this.SwitchMode("Beginner (9x9, 10 Mines)")
