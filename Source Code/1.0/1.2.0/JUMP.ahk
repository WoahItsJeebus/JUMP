...
class MinesweeperApp {
    __New() {
        ...
        this.TxtMines := this.Gui.AddText("x10 y5 w80", "Mines: 0")
        this.TxtTime  := this.Gui.AddText("x10 y+m w80", "Time: 0")
		...
		this.Gui.Title := "JUMP - Minesweeper (" this.W "x" this.H ", " this.Mines " mines)"
